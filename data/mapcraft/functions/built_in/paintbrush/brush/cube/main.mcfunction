...
execute if score @s MC_BrushWidth matches 9 as @e[tag=Cursor,tag=One] if score @s MC_CursorTemp = @p[distance=0] MC_PlayerID if score @s MC_IsMove matches 1 at @s positioned ~ ~4 ~ run function mapcraft:built_in/paintbrush/brush/cube/9/main
execute if score @s MC_BrushWidth matches 11 as @e[tag=Cursor,tag=One] if score @s MC_CursorTemp = @p[distance=0] MC_PlayerID if score @s MC_IsMove matches 1 at @s positioned ~ ~5 ~ run function mapcraft:built_in/paintbrush/brush/cube/11/main
