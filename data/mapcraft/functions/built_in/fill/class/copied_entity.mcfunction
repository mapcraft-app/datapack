execute at @s run clone ~ ~ ~ ~ ~ ~ 1 -64 0 replace force
execute at @e[type=player,tag=Fill] if score @p[distance=0] MC_PlayerID = @s MC_FillID if entity @p[distance=0,tag=Cut] at @s run clone 1 -63 0 1 -63 0 ~ ~ ~
